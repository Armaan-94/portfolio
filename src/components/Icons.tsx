...
export function LeetCodeIcon(props: IconProps) {
  return (
    <svg {...base} fill="currentColor" stroke="none" {...props}>
      <path d="M16.1 3.3a1.2 1.2 0 0 0-1.7 0L6.6 11a3.9 3.9 0 0 0 0 5.5l3.8 3.9a3.9 3.9 0 0 0 5.5 0l2-2a1.2 1.2 0 0 0-1.7-1.7l-2 2a1.5 1.5 0 0 1-2.1 0l-3.8-3.9a1.5 1.5 0 0 1 0-2.1l7.8-7.7a1.2 1.2 0 0 0 0-1.7Z" />
      <path d="M20.4 12.1h-8.2a1.2 1.2 0 1 0 0 2.4h8.2a1.2 1.2 0 0 0 0-2.4Z" />
      <path d="M13.4 3.3 10.9 5.8a1.2 1.2 0 0 0 1.7 1.7l2.5-2.5a1.2 1.2 0 0 0-1.7-1.7Z" />
    </svg>
  );
}
